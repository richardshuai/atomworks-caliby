...
# ============================================================
def get_ang(a: torch.Tensor, b: torch.Tensor, c: torch.Tensor) -> torch.Tensor:
...
# ============================================================
def get_dih(a: torch.Tensor, b: torch.Tensor, c: torch.Tensor, d: torch.Tensor) -> torch.Tensor:
...
# ============================================================
def get_frames(a: torch.Tensor, b: torch.Tensor, c: torch.Tensor) -> torch.Tensor:
...
# ============================================================
def triple_prod(a: torch.Tensor, b: torch.Tensor, c: torch.Tensor, norm: bool = False) -> torch.Tensor:
    ...
    if norm == True:
        ...
        bxc = torch.cross(
            input=F.normalize(b, dim=-1),  # b/b.norm(dim=-1,keepdim=True),
