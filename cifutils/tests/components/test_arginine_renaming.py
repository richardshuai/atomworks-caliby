...
from tests.conftest import CIF_PARSER, TEST_DATA_DIR, get_pdb_path
...
def test_arginine_renaming():
    ...
    result1 = CIF_PARSER.parse(filename=correct_file, build_assembly=None)
    result2 = CIF_PARSER.parse(filename=renamed_file, build_assembly=None, fix_arginines=True)
