...
This example demonstrates how to use the `cifutils` package to load, inspect, and manipulate mmCIF structure files. You'll see how to parse a structure, visualize it, and perform basic analysis.
"""
...
We start by loading a structure from an mmCIF file using `cifutils.parse`. This function supports various file formats and allows you to specify options such as which assembly to build, whether to add missing atoms, and more.
"""
...
You can visualize the asymmetric unit or any assembly using the built-in viewer from `cifutils`. This is helpful for quickly inspecting the structure and its components.
"""
