...
PYTHONPATH=$PWD:$PYTHONPATH /projects/ml/RF2_allatom/spec_files/datahub_latest.sif pytest --cov=datahub --cov-report=xml--cov-report=term-missing -m "not very_slow" tests/
